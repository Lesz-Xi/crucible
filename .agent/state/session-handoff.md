...
- Branch: `master`
- Dirty summary: modified=4, untracked=12, staged=0
...
- `fec2c972` chore: synchronize submodules and update implementation plans (2026-02-17T16:44:49+08:00)
- `56d1a51f` docs: add bio-lab production audit and implementation plan (2026-02-17T06:37:05+08:00)
...
Pending migration files detected: 41
