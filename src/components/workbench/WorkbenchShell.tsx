    ...
    <div className={cn('lab-shell min-h-screen w-full', className)}>
      ...
      <div className="mx-auto max-w-[1760px] px-4 pb-6 pt-4 md:px-6 lg:px-8">
        <div className="hidden lg:grid lg:grid-cols-[320px_minmax(720px,1fr)_360px] lg:gap-4">
          <aside className="lab-panel h-[calc(100vh-132px)] overflow-hidden">{contextRail}</aside>
          <main className="lab-panel-elevated h-[calc(100vh-132px)] overflow-hidden">{primary}</main>
          <aside className="lab-panel h-[calc(100vh-132px)] overflow-hidden">{evidenceRail}</aside>
        </div>
