          ...
          <div className="mt-6 hidden gap-6 md:grid lg:grid-cols-[minmax(0,0.92fr)_minmax(0,1.08fr)] lg:items-stretch">
                ...
                <button
                  ...
                  className={`group hd-panel-soft relative flex h-full min-h-0 flex-col overflow-hidden rounded-[24px] p-4 text-left transition-all duration-200 md:p-5 ${
                    activeKey === module.key
                      ? "border-[var(--border-glow)] bg-[var(--bg-elevated)] shadow-[0_0_0_1px_rgba(166,124,82,0.16),0_8px_24px_rgba(0,0,0,0.08)]"
                      : ""
                  }`}
                >
                  <div
                    className={`pointer-events-none absolute inset-0 rounded-[24px] border transition-all duration-200 ${
                      activeKey === module.key
                        ? "border-[var(--border-glow)] shadow-[inset_0_0_0_1px_rgba(166,124,82,0.08),0_0_0_1px_rgba(166,124,82,0.10)]"
                        : "border-transparent"
                    }`}
                  />
            ...
            <div className="grid h-full gap-4 lg:grid-rows-2">
              <div className="relative h-full min-h-0 overflow-hidden rounded-[30px] border border-[var(--border-subtle)] bg-[var(--bg-secondary)]">
                <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_22%_18%,rgba(166,124,82,0.06),transparent_34%),radial-gradient(circle_at_78%_72%,rgba(166,124,82,0.03),transparent_32%)]" />
                ...
                {connections.map(([from, to], index) => {
                  ...
                  return (
                    <motion.path
                      ...
                      stroke={isActive ? "#a67c52" : "rgba(166,124,82,0.3)"}
              ...
              <div className="relative h-full min-h-0 overflow-hidden rounded-[30px] border border-[var(--border-subtle)] bg-[var(--bg-secondary)] shadow-[var(--shadow-soft)]">
                <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_22%_18%,rgba(166,124,82,0.04),transparent_30%),radial-gradient(circle_at_78%_72%,rgba(166,124,82,0.02),transparent_28%)]" />
                    ...
                    <div className="grid h-full gap-3 md:grid-cols-4">
                      {activeModule.protocol.map((step, index) => {
                        ...
                        const stepBackground =
                          "linear-gradient(135deg, rgba(166,124,82,0.07), rgba(166,124,82,0.02))";
                        const stepState =
                          index === 0
                            ? "Intake"
                            : index === 1
                        ...
                        return (
                          <div
                            key={step}
                            className="group relative flex h-full min-h-[0] flex-col rounded-[18px] border border-[var(--border-color,#e5e7eb)] px-4 py-4 shadow-[0_2px_8px_rgba(0,0,0,0.05)] transition-all duration-200 hover:border-[var(--border-glow)] hover:shadow-[0_0_0_1px_rgba(166,124,82,0.12),0_6px_20px_rgba(0,0,0,0.07)]"
                            style={{ background: stepBackground }}
                          >
                            {!isFinal ? (
                              <div className="pointer-events-none absolute -right-2 top-1/2 hidden h-px w-4 -translate-y-1/2 bg-[linear-gradient(90deg,rgba(166,124,82,0.5),rgba(166,124,82,0.08))] md:block" />
                            ) : null}
                        ...
                        <div className="mt-4 min-h-[2.75rem]">
                              <p className="inline-flex max-w-full items-start gap-2 break-words font-mono text-[10px] uppercase tracking-[0.14em] text-[var(--accent-rust-strong)]">
                                <span className="h-1.5 w-1.5 rounded-full bg-[var(--accent-rust-strong)] shadow-[0_0_8px_rgba(166,124,82,0.35)]" />
                    ...
                    <span
                      className={`rounded-full border px-2.5 py-1 font-mono text-[9px] uppercase tracking-[0.16em] ${
                        module.status === "Primary path"
                          ? "border-[var(--border-glow)] bg-[linear-gradient(90deg,rgba(166,124,82,0.08),rgba(166,124,82,0.04))] text-[var(--accent-rust-strong)]"
                          : "border-[var(--border-subtle)] bg-[var(--bg-tertiary)] text-[var(--text-secondary)]"
                      }`}
                    >
                      {module.status}
