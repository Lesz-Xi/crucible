  ...
  return (
    ...
    >
      {!mobileSidebarOpen ? (
        <button
          type="button"
          className={cn('mobile-shell-trigger fixed top-3 left-3 z-[100] bg-black/40 backdrop-blur-md rounded-md p-1.5 border border-white/10 shadow-lg text-white hover:bg-black/60 transition-colors', (sidebarCollapsed || focusModeActive) && 'is-visible', focusModeActive && 'is-focus-exit')}
          onClick={handleMainSurfaceChromeToggle}
