  ...
  return (
    <section className="bg-[var(--bg-primary)] py-20 md:py-24">
      <div className="mx-auto max-w-7xl px-6 md:px-8">
        ...
        <div className="mt-12 rounded-2xl border border-[var(--border-subtle)] bg-[var(--bg-secondary)] p-8">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            {architecturePatterns.map((item) => (
              <div key={item.pattern} className="rounded-xl bg-[var(--bg-elevated)] p-6">
        ...
        {/* Open Source Note */}
        <div className="mt-8 rounded-2xl border border-[var(--border-subtle)] bg-[var(--accent-blue-soft)] p-8 text-center">
