  ...
  return (
    <section className="bg-[var(--bg-secondary)] py-20 md:py-24">
      <div className="mx-auto max-w-7xl px-6 md:px-8">
        ...
        {/* Benchmark Results */}
        <div className="mt-12 rounded-2xl border border-[var(--border-subtle)] bg-[var(--bg-elevated)] p-8">
          ...
          <div className="mt-8 rounded-xl border border-[var(--border-subtle)] bg-[rgba(97,121,91,0.12)] p-6 dark:bg-[rgba(125,156,128,0.14)]">
            <h4 className="mb-2 font-mono text-xs uppercase tracking-[0.2em] text-[var(--accent-moss)]">
        ...
        {/* Limitations Callout */}
        <div className="mt-8 rounded-2xl border border-[var(--border-subtle)] bg-[var(--accent-rust-soft)] p-8">
